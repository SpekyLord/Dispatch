...
- Carryover: live passive sensing integrations, mesh-relayed survivor resolve packets, and the remaining 4-EXT.4/4-EXT.5 work stay open in `docs/phase4-extended.md`.
